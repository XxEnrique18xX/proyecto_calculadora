  ...
  const calcularResultados = () => {
    ...
    for (let i = 0; i < restrics.length; i++) {
      for (let j = i + 1; j < restrics.length; j++) {
        ...
        if (det !== 0) {
          const x1 = (r1.valor * r2.x2 - r2.valor * r1.x2) / det;
          const x2 = (r1.x1 * r2.valor - r2.x1 * r1.valor) / det;
        ...
        >
          <div className="card-body text-center">
            <h1 className="card-title mb-4" style={{ color: "#7fc0f5" }}>
              Método gráfico con maximización
            </h1>
            <form className="mt-4">
              {/* Función Objetivo */}
              <div className="mb-4">
            ...
            {resultados.length > 0 && (
              <div style={{ marginTop: 30 }}>
                <h3 style={{ color: "#b3cdca" }}>
                  Resultados (Puntos factibles):
                </h3>
                <table
                  border="1"
                  cellPadding="6"
                ...
                <h4 style={{ marginTop: 15, color: "#8bc34a" }}>
                  Máximo Z: {Math.max(...resultados.map((r) => r.z)).toFixed(2)}
                </h4>
                {/* Gráfico */}
